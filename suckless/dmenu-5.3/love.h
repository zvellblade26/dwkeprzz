...
static const char *fonts[] = {
	...
	//"SF Pro Display:style=Regular:pixelsize=28:antialias=true:autohint=true"
	"SF Pro:style=Regular:pixelsize=28:antialias=true:autohint=true"
	//"SF Pro Text:style=Regular:pixelsize=28:antialias=true:autohint=true"
